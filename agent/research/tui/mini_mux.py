    ...
    def write(self, data: bytes):
        ...
        while True:
            ...
            # ---- 3) scroll-region -----------------------------------------
                ...
                out.extend(f"\x1b[{self.row_off+top-1};{self.row_off+bot-1}r".encode())
        ...
        out.extend(self.buf); self.buf.clear()
