...
1. opening shell tag on its own line: <shell>
2. your desired command or commands. eg: echo this is my echo
3. the closing shell tag on its own line: </shell>
...
<details>
- You should only submit one shell block per message.
...
- You can have as many lines as you need within your shell block. They will be executed sequentially by the shell, as if you typed them into your terminal line by line.
</details>

<results-explained>
Once you end your message, your shell block will be automatically parsed and executed, and you will receive any stdout/stderr produced as well as the exit status for your block.
